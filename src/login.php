...
?>
                  ...
                  <div class="text-center pt-1 mb-5 pb-1">
                    <input class="shadow form-control btn btn-primary btn-lg active rounded-4 fw-bold nav-under" name="submit" value="Entrar" type="submit"> <br>
                  </div>
                      <!-- <div class="mt-2">
            ...
            <div class="rounded-5 col-lg-6 d-none d-lg-flex align-items-center justify-content-center gradient-custom">
              <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                ...
                <h4 class="mb-2 undertale">Desvenda, nobre visitante, a vasta panóplia de jogos virtuais na Game Rail.</h4>
              </div>
            </div>
          </div>
        </div>
