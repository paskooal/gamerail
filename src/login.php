          ...
          <div class="row g-0">
            <div class="col-lg-6">
              <div class="card-body p-md-5 mx-md-4">
                ...
                <form action="verify/logarUser.php" method="post" class="text-white">
                  ...
                  <div class="text-center pt-1 mb-5 pb-1">
                    <input class="shadow form-control btn btn-primary btn-lg active" name="submit" value="Entrar" type="submit">
                      <br>
                      <div class="mt-2">
