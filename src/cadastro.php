    ...
    <section class="h-100">
      <div class="container h-100">
        <div class="row d-flex justify-content-center align-items-center h-100">
          <div class="col-xl-10">
            <div style="background-color: #42006a;" class="card card-shadow border-0 rounded-5 text-black"
              style="height: 100%;">
              <div class="row g-0">
                <div class="col-lg-6">
                  <div class="card-body p-md-5 mx-md-4">
                    ...
                    <form autocomplete="off" data-parsley-validate action="back/salvarUser.php" id="cadastro"
                      ...
                      <div class="text-white form-floating mb-4">
                        <input required data-parsley-length="[4,20]" data-parsley-pattern="^\S+$"
                          data-parsley-pattern-message="*Este campo não pode conter espaços em branco."
                          data-parsley-length-message="*Este campo deve ter entre 4 á 20 digitos." type="text"
                      ...
                      <div class="text-white form-floating mb-4">
                        <input required data-parsley-trigger="change" type="email" name="email" required
                          data-parsley-length="[8,100]" data-parsley-pattern="^\S+$"
                          data-parsley-pattern-message="*Este campo não pode conter espaços em branco."
