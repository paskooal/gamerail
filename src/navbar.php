<nav class="navbar navbar-expand-lg bg-primary shadow-gg fs-5">
    <div class="container-fluid justify-content-center">
      <ul class="navbar-nav mb-2 mt-2 align-items-center mx-auto">
        ...
        <div class="d-lg-flex d-none d-lg-block">
          <li class="nav-item nav-border-l">
            <a class="nav-link nav-under" href="#">Destaques</a>
          </li>
          <li class="nav-item">
            <a class="nav-link nav-under" href="#">Promoções</a>
          </li>
          ...
          <ul class="navbar-nav d-flex flex-row nav-border-l ms-3 me-3 align-items-center">
            <li class="nav-item">
              ...
              if (!isset($_SESSION['senha']) || !isset($_SESSION['email'])) {
                echo "<a class='fs-5 btn btn-dark nav-under rounded-4 ms-3' href='src/login.php'>Login</a>";
              } else {
                echo "<a class='fs-5 btn btn-dark nav-under rounded-4 ms-3' href='src/back/logout.php'>Logout</a>";
              }
              ?>
            </li>
            <?php
            if (isset($_SESSION['senha']) && isset($_SESSION['email'])) {
              ...
              if (isset($resultado['adminUnlock']) && $resultado['adminUnlock'] == 1) {
                echo $_SESSION['menuDev'];
              }
            }
            ?>
          </ul>
      ...
      <button class="btn btn-primary d-lg-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop" aria-controls="offcanvasTop"><i class="bi bi-list h1"></i></button>
    </div>
    </li>
    </ul>
    </ul>
      ...
      <div class="offcanvas-header d-flex align-items-center">
        ...
        if (isset($_SESSION['senha']) || isset($_SESSION['email'])) {
          echo '<div class="nav-item dropdown">
              <a class="nav-link dropdown-toggle ms-3" href="#" id="navDrop" role="button" data-bs-toggle="dropdown"
                aria-expanded="false">
                <img src="images\matt.webp" class="rounded-circle" height="40" alt="" loading="lazy" />
              </a>
              <ul id="navDrop" class="dropdown-menu">
    ...
    <div class="offcanvas-body">
      <ul class="navbar-nav">
        ...
        <li>
          <a class="nav-link nav-mobile mb-2 rounded-4  d-flex justify-content-center" href="#">Destaques</a>
        </li>
        <li>
          <a class="nav-link nav-mobile mb-2 rounded-4 d-flex justify-content-center" href="#">Promoções</a>
        </li>
        <li class="nav-item">
